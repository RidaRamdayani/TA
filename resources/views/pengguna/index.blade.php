        ...
        <header class="py-2">
            <div class="container-fluid pb-5">
                ...
                <div class="border resp">
                    <iframe style="height: 100%; width: 100%;" src="https://lookerstudio.google.com/embed/reporting/be617ece-926a-42e1-9984-5a37b81aa3cc/page/1uJmD" frameborder="0" style="border:0" allowfullscreen sandbox="allow-storage-access-by-user-activation allow-scripts allow-same-origin allow-popups allow-popups-to-escape-sandbox">
                    </iframe>
                </div>
                <!-- </div> -->
            </div>
    ...
    <footer class="bg-white py-4 mt-auto">
        <div class="container px-5">
            <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                <div class="col-auto">
                    <div class="small m-0">&copy;website visualisasi data</div>
                </div>
                <div class="col-auto">
